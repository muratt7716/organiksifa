/**
 * Türkiye il listesi. Adres alanında serbest metin yerine açılır liste
 * kullanılır — yanlış il yazımı kargo iadesi ve çift kargo bedeli demektir.
 */
...
export function ilGecerliMi(deger: string): boolean {
  return (TR_ILLER as readonly string[]).includes(deger);
}
